...
/**
 * Here we will test the connection to the catalog component,
 * we will use the real catalog repository with an h2 test database,
 * delivered by the @DataJpaTest Annotation
 */
